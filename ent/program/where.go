...
func HasAuthor() predicate.Program {
	return predicate.Program(func(s *sql.Selector) {
...
func HasAuthorWith(preds ...predicate.User) predicate.Program {
	return predicate.Program(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasWorkouts() predicate.Program {
	return predicate.Program(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(WorkoutsTable, FieldID),
...
func HasWorkoutsWith(preds ...predicate.Workout) predicate.Program {
	return predicate.Program(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
